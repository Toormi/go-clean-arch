...
import (
	...
	articleMysqlRepo "github.com/toormi/go-clean-arch/persistence/repository_impl"
	"testing"
	"time"
...
func TestFetchArticle(t *testing.T) {
	...
	mockArticles := []persistence.Article{
		{
			ID: 1, Title: "title 1", Content: "content 1",
			Author: persistence.Author{ID: 1}, UpdatedAt: time.Now(), CreatedAt: time.Now(),
		},
		{
	...
	cursor := articleMysqlRepo.EncodeCursor(mockArticles[1].CreatedAt)
	num := int64(2)
