...
import (
	...
	facade2 "github.com/bxcodec/go-clean-arch/internal/domain/article/repository/facade"
	"time"
...
type Service struct {
	articleRepo facade2.ArticleRepository
	authorRepo  facade2.AuthorRepository
}

// NewService will create a new article service object
func NewService(a facade2.ArticleRepository, ar facade2.AuthorRepository) *Service {
	return &Service{
		articleRepo: a,
		authorRepo:  ar,
	}
