...
import (
	...
	entity "github.com/toormi/go-clean-arch/internal/article-domain/domain/entity"
)
...
func (_m *ArticleService) Fetch(ctx context.Context, cursor string, num int64) ([]entity.Article, string, error) {
	...
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) ([]entity.Article, string, error)); ok {
		return rf(ctx, cursor, num)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) []entity.Article); ok {
...
func (_m *ArticleService) GetByID(ctx context.Context, id int64) (entity.Article, error) {
	ret := _m.Called(ctx, id)
...
func (_m *ArticleService) GetByTitle(ctx context.Context, title string) (entity.Article, error) {
...
func (_m *ArticleService) Store(_a0 context.Context, _a1 *entity.Article) error {
...
func (_m *ArticleService) Update(ctx context.Context, ar *entity.Article) error {
