...
import (
	...
	"github.com/toormi/go-clean-arch/internal/article-domain/repository/mocks"
...
func TestStore(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockArticleRepo.On("GetByTitle", mock.Anything, mock.AnythingOfType("string")).Return(entity.Article{}, server.ErrNotFound).Once()
