...
func (_m *ArticleRepository) Fetch(ctx context.Context, cursor string, num int64) ([]entity.Article, string, error) {
...
func (_m *ArticleRepository) Store(ctx context.Context, a *entity.Article) error {
	ret := _m.Called(ctx, a)
...
func (_m *ArticleRepository) Update(ctx context.Context, ar *entity.Article) error {
