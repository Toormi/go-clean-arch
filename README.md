...
- **v1**: checkout to the [v1 branch](https://github.com/toormi/go-clean-arch/tree/v1) <br>
...
- **v2**: checkout to the [v2 branch](https://github.com/toormi/go-clean-arch/tree/v2) <br>
...
- **v3**: checkout to the [v3 branch](https://github.com/toormi/go-clean-arch/tree/v3) <br>
  Proposed on 2019, merged to master on 2020. <br>
  Desc: Introducing Domain package, the details can be seen on this PR [#21](https://github.com/toormi/go-clean-arch/pull/21)
...
- **v4**: master branch
  ...
  Details can be seen in this PR [#88](https://github.com/toormi/go-clean-arch/pull/88).<br>
...
![golang clean architecture](https://github.com/toormi/go-clean-arch/raw/master/clean-arch.png)
...
$ git clone https://github.com/toormi/go-clean-arch.git
...
- All libraries listed in [`go.mod`](https://github.com/toormi/go-clean-arch/blob/master/go.mod)
